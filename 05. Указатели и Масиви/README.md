...
**Задача 19.** _**Counting sort**_: Нека е даден масив от `unsigned short` с дължина $n >> 65535$. Напиешете функция, която сортира масива в линейно време (т.е. с константен брой обхождания.
